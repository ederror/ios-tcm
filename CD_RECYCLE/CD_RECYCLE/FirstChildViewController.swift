...
class FirstChildViewController: UIViewController { // 가로 쓰레기통
    ...
    override func viewDidLoad() {
        ...
        let mapView = NMFNaverMapView(frame: CGRect(x: view.frame.origin.x, y: view.frame.origin.y, width: 343.0, height: 516.0))
        ...
        getCoords(url: url, trash_type: "일반쓰레기",handler: { jsonList in
